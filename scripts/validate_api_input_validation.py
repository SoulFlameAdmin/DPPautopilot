...
required={
  ...
  "oversize_parsed_organizations_body","oversize_parsed_members_body",
...
covered_body_files={"tenant.js","organizations.js","members.js","models.js","items.js","passport.js","imports.js"}
...
print("R03_API_INPUT_VALIDATION_CONTRACT_PASS: 1 MiB shared body limit + 18 negative API/file-policy scenarios are versioned; inventoried body surfaces including M20 imports are covered")
